        ...
        <?php include(ROOT_PATH . '/include/message.php'); ?>
            ...
            <div class="headlines-section">
                ...
                <div class="main-news">
                    ...
                    <div class="main-news__label">
                        <a href="<?php echo BASE_URL . 'article.php?id=' . $post['id']?>"><?php echo $post['title'] ?></a>
                    </div>
            ...
            foreach ($topics_parent as $topic) {
                ...
                if (count($post_main)>=1) {
                    ...
                    <!-- begin TOPIC -->
                <div class="category">
                    <h2 class="category__heading"><a href="category.php?id=<?php echo $topic['id'] ?>" style="text-decoration: none;"><?php echo getTopicNameByID($topic['id']) ?></a></h2>
                    <div class="category__content">
                        ...
                        <div class="grid__column-6 main-category">
                            ...
                            <div class="main-news__action">
                                ...
                                <div class="main-news__comment">
                                    <i class="far fa-comment"></i>
                                    <span class="main-news__comment-label"><?php echo getCommentsNumberOfPost($post_main[0]['id']); ?></span>
                                </div>
                            </div>
                        </div>
                        <!-- main new end -->
                                ...
                                <div class="sub-news__info">
                                    ...
                                    <div class="sub-news__action">
                                        ...
                                        <div class="sub-news__comment">
                                            <i class="far fa-comment"></i>
                                            <span class="sub-news__comment-label"><?php echo getCommentsNumberOfPost($post['id']); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
